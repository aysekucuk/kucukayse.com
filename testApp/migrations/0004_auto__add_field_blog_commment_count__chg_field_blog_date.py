...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Blog.commment_count'
        db.add_column(u'testApp_blog', 'commment_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


        # Changing field 'Blog.date'
        db.alter_column(u'testApp_blog', 'date', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):
        # Deleting field 'Blog.commment_count'
        db.delete_column(u'testApp_blog', 'commment_count')


        # Changing field 'Blog.date'
        db.alter_column(u'testApp_blog', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
