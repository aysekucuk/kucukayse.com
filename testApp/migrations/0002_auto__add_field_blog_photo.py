...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Blog.photo'
        db.add_column(u'testApp_blog', 'photo',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['testApp.Media'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Blog.photo'
        db.delete_column(u'testApp_blog', 'photo_id')
